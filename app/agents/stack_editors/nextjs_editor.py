# app/agents/stack_editors/nextjs_editor.py
...
def apply_nextjs_frontend_edits(repo_path: str, fp: StackFingerprint, goal: str) -> Dict[str, Any]:
    ...
    # Next often has styles/globals.css
    candidates = [
        "styles/globals.css",
        "app/globals.css",
